...
export default function LimitedTimeEventPage({
  ...
  useEffect(() => {
    // Load Brevo form stylesheet
    const brevoLink = document.createElement("link");
    brevoLink.rel = "stylesheet";
    brevoLink.href = "https://sibforms.com/forms/end-form/build/sib-styles.css";
    document.head.appendChild(brevoLink);
    ...
    return () => {
      // Cleanup: remove scripts and link when component unmounts
      if (document.body.contains(brevoScript)) {
        document.body.removeChild(brevoScript);
      }
      if (document.head.contains(brevoLink)) {
        document.head.removeChild(brevoLink);
      }
    };
  }, []);
          ...
          <div id="sib-form-container" className="sib-form-container">
            ...
            >
              <form
                id="sib-form"
                method="POST"
                action="https://4f2904b9.sibforms.com/serve/MUIFAJVCZWJgqTTjFyDN6ESS4rN25X_EfUfcRNa0Fp8aUGrUKbfaN3IiOb3K3fB4YO-baXS9BkPFry9xYf70rG2xKAdqllOhdyCco6k9QTO98PVM1F9ZSyNir8yZUroIou3KhB5AHfovrKFsYe38fPErWpHoJbKxwNekxw8VFE6LM6uxvhys701FtkwtghAeb-OfMoxObmwf8AAPVQ=="
              ...
              >
                <div style={{ padding: "8px 0" }}>
                  ...
                  >
                    <p>Shape the Future of HeirFlow</p>
                  </div>
                </div>
                <div style={{ padding: "8px 0" }}>
                  <div
                  ...
                  >
                    <div className="sib-text-form-block">
                      <p>Built by probate attorneys. Shaped by your feedback.</p>
                    </div>
                  </div>
                </div>
                <div style={{ padding: "8px 0" }}>
                      ...
                      <div className="form__label-row">
                        ...
                        <div className="entry__field">
                          <input
                            ...
                            name="EMAIL"
                            autoComplete="off"
                            placeholder="your.email@exmaple.com"
                            data-required="true"
                            required
                          />
                        </div>
                    ...
                    <div className="form__entry entry_block">
                      <div className="form__label-row">
                        <label
                          ...
                          htmlFor="AVG_PROBATES_PER_MONTH"
                          data-required="*"
                        >
                          On average, how many probate matters do you handle per
                          month?
                        </label>
                        <div className="entry__field">
                          <select
                            className="input"
                            id="AVG_PROBATES_PER_MONTH"
                            name="AVG_PROBATES_PER_MONTH"
                            data-required="true"
                          >
