...
export default function ProbateChecklistPage({
  onNavigate,
}: ProbateChecklistPageProps) {
  useEffect(() => {
          ...
          <div id="sib-form-container" className="sib-form-container">
            ...
            >
              <form
                id="sib-form"
                method="POST"
                action="https://4f2904b9.sibforms.com/serve/MUIFAOuDTurYBlZtnMeEVsav0JbkAsHjQBXvWFnaHmg0qaAr-Bbq5zn2VAiM6TjEyWvXljsjeVDninP7ETEBlPIPvIfOcRvCjqAycHaUKaBBTFP70Ka9ZTcebQEM-v33ZtHUtKPeqbZ5zLXM9s67CpOqD2D9a3I_yfIgik8qjpow5S7OUWmOeDe8r_s3uiacCbTRnxPNtThiItKSHw=="
              ...
              >
                <div style={{ padding: "8px 0" }}>
                  ...
                  >
                    <p>Get Your Free Probate Survival Guide</p>
                  </div>
                </div>
                <div style={{ padding: "8px 0" }}>
                  <div
                  ...
                  >
                    <div className="sib-text-form-block">
                      <p>
                        The probate court submission process can be brutal if
                        you miss key steps. Court clerks will reject your
                        submission, causing delays and frustration. Get your
                        free Probate Survival Guide—a comprehensive walkthrough
                        that ensures you don't miss any critical steps and helps
