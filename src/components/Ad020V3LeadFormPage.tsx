...
<div class="sib-form" style="text-align: center; background-color: #f1f6fd;">
  <div id="sib-form-container" class="sib-form-container">
    ...
    <div id="sib-container" class="sib-container--large sib-container--vertical" style="text-align:center; background-color:rgba(255,255,255,1); max-width:540px; border-radius:10px; border-width:1px; border-color:#C0CCD9; border-style:solid; direction:ltr; margin:0 auto;">
      <form id="sib-form" method="POST" action="https://4f2904b9.sibforms.com/serve/MUIFAJtfmoXZCnZS5_kkcqmt-hkbepIFsnGR0MfrBnREz9rkWvUGOwCLwrbU_NCQjz_2WnztgjaEcTM9XDzAT6QGerI4peBF-lHr6tnHOEx5NTNBO09Vu4SJ6yhSmYjVV0tzWuyFfOMqFfssDrKeRvXdo_LMcXGIEQYHCnEpY-dhXPnErQKnK4Yuhy2Jhg8Ea_1FQHOWqD0Y3niSOg==" data-type="subscription">
        ...
        <div style="padding: 8px 0;">
          <div class="sib-form-block" style="font-size:16px; text-align:left; font-family:Helvetica, sans-serif; color:#1e293b; background-color:transparent;">
            <div class="sib-text-form-block">
              <p>Share a few details and our team will follow up to discuss fit and next steps.</p>
            </div>
          </div>
        </div>
        <div style="padding: 8px 0;">
        ...
        <div style="padding: 8px 0;">
          <div class="sib-input sib-form-block">
            <div class="form__entry entry_block">
              <div class="form__label-row">
                <label class="entry__label" style="font-weight:500; text-align:left; font-size:16px; font-family:Helvetica, sans-serif; color:#1e293b;" for="SHORT_ANSWER" data-required="*">Interest in HeirFlow</label>
                <div class="entry__field">
