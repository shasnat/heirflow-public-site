...
interface Ad020V3LandingPageProps {
  onNavigate: (
    page:
      | "landing"
      | "consultation"
...
export default function Ad020V3LandingPage({
  onNavigate,
}: Ad020V3LandingPageProps) {
  const handleGetStartedClick = () => {
    trackStandardEvent("Contact", {
      pageName: "ad-020-v3-landing",
      adId: "ad-020-v3",
    });
    trackEvent("Ad020V3LeadFormClick", {
      adId: "ad-020-v3",
      pageName: "ad-020-v3-landing",
      ctaText: "See your next step",
    });
    onNavigate("ad-020-v3-schedule-demo");
  };
